...
?>
  ...
  <div class="site-wrap">
          ...
          <ul class="site-menu js-clone-nav d-none d-md-block">
            <li class="has-children active">
              ...
              <ul class="dropdown arrow-top">
                <li><a href="équipes.php">Equipe</a></li>
                <li><a href="à%20propos.php">A propos</a></li>
                <li><a href="contact.php">Contact</a></li>
              </ul>
            </li>
            <li><a href="classement.php">Classement</a></li>
            <li><a href="" data-toggle="modal" data-target="#modalLoginForm">Se connecter</a></li>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/volleyballfeminin4.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
            <h1 class="bg-text-line">À propos de nous</h1>
