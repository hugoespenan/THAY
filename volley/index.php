...
<body>
	<div class="site-wrap">
		...
		<div class="slide-one-item home-slider owl-carousel">
			<div class="site-blocks-cover overlay" data-aos="fade" data-stellar-background-ratio="0.5" style="background-image: url(images/paris4.jpg);">
				<div class="container">
					<div class="row align-items-center justify-content-start">
						<div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400"></div>
					</div>
				</div>
			</div>
			<div class="site-blocks-cover overlay" data-aos="fade" data-stellar-background-ratio="0.5" style="background-image: url(images/paris2.jpg);">
				<div class="container">
					<div class="row align-items-center justify-content-start">
						<div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400"></div>
					</div>
			...
			<div class="site-blocks-cover overlay" data-aos="fade" data-stellar-background-ratio="0.5" style="background-image: url(images/paris3.jpg);">
				<div class="container">
					<div class="row align-items-center justify-content-start">
						<div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400"></div>
					</div>
							...
							<div class="card-deck">
								<div class="card text-center">
									<div class="card-block">
										...
										<p class="card-text">Apply for parking permit<br>
										View existing permit requests<br>
										Activate Visitor permits<br></p>
									</div>
								...
								<div class="modal-body modal-form mx-3">
									...
									<div class="col-sm-6 col-xs-12">
										...
										<div class="col-xs-12 mt20">
											...
											<div class="">
												<input class="" id="member_user_registration_form_member_last_name" name="nom" placeholder="Entrez votre nom de famille" required="required" type="text">
											</div>
										</div><!--Prenom-->
										<div class="col-xs-12 mt20">
											<span class=""><label class="required" for="member_user_registration_form_member_last_name">Prénom *</label></span>
											<div class="">
												<input class="" id="member_user_registration_form_member_last_name" name="prenom" placeholder="Entrez votre prénom" required="required" type="text">
											</div>
										</div><!--Genre-->
										<div class="col-xs-12 mt20">
											<span class="input-select"><label class="required" for="member_user_registration_form_member_gender">Genre *</label></span>
											<div class="select">
												<select class="" id="member_user_registration_form_member_gender" name="genre" required="required" style="width:100%">
										...
										<div class="col-xs-12 mt20">
											...
											<div class="col-xs-4 custom-col">
												<select class="form-control j_register_birthday" id="member_user_registration_form_member_birthdate_day" name="jour">
													<option value="1">
														01
													</option>
													<option value="2">
											...
											<div class="col-xs-4 custom-col">
												<select class="form-control j_register_birthday" id="member_user_registration_form_member_birthdate_month" name="mois">
													<option value="1">
														01
													</option>
													<option value="2">
											...
											<div class="col-xs-4 custom-col">
												<select class="form-control j_register_birthday" id="member_user_registration_form_member_birthdate_year" name="annee">
													<option value="2023">
														2023
													</option>
													<option value="2022">
									...
									<div class="col-sm-7 col-xs-12">
										...
										<div class="col-xs-12 mt10">
											<div class="">
												...
												<div class="color-city">
													<input class=" auto-city" id="member_user_registration_form_member_city" name="ville" placeholder="Ville" required="required" type="text">
												</div>
											</div>
										...
										<div class="col-xs-12 mt10">
											...
											<div class="">
												<input class="" id="member_user_registration_form_member_phone_number" name="tel" placeholder="Entrez le numéro de téléphone" required="required" type="text">
											</div>
										</div><!--Adresse Mail-->
										<div class="col-xs-12 mt10">
											<span class=""><label class="required" for="member_user_registration_form_email">Login * :</label></span>
											<div class="">
												<input class="form-control" id="member_user_registration_form_email" name="login" placeholder="Saisir un email" required="required" type="text">
											</div>
										</div><!--Mot de passe-->
										<div class="col-xs-12 mt10">
											<div class="">
												<div id="member_user_registration_form_plainPassword">
													<div>
														<label class="required" for="member_user_registration_form_plainPassword_first">Mot de passe * :</label> <input class="form-control" id="member_user_registration_form_plainPassword_first" name="mdp" placeholder="Saisir un mot de passe" required="required" type="password">
													</div>
												</div>
											</div>
										</div>
